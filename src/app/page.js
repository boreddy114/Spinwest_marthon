    ...
    <div className="app-container">
      ...
      <header className="premium-header">
        <div className="header-logo-container">
          ...
          <span className="logo-tagline">Event Gallery</span>
        </div>
      ...
      <main className="main-content">
        <div className="container">
          ...
          <div className="hero-banner animate-fade-in">
            <h1 className="hero-title">Spine West Photo Gallery</h1>
            <p className="hero-subtitle">
              We are proud to support active, healthy lifestyles in our community. Browse, view, and download free high-resolution photos from our sponsored community and athletic events.
            </p>
          </div>
          ...
          <div className="info-feature-row animate-fade-in" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginBottom: '4rem' }}>
            ...
            <div className="info-card" style={{ background: '#ffffff', border: '1px solid rgba(46, 125, 50, 0.08)', borderRadius: '20px', padding: '2rem', boxShadow: 'var(--shadow-sm)' }}>
              ...
              <div style={{ fontSize: '0.85rem', color: 'var(--color-text-muted-dark)' }}>
                <strong>Goal:</strong> Keep you active, pain-free, and doing what you love.<br />
                <strong>Practice:</strong> Celebrating 25 years of care in Boulder, Colorado.
              </div>
            </div>

            {/* Spine West Info Card 2 */}
            <div className="info-card" style={{ background: '#ffffff', border: '1px solid rgba(46, 125, 50, 0.08)', borderRadius: '20px', padding: '2rem', boxShadow: 'var(--shadow-sm)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1.25rem' }}>
                <span style={{ background: 'rgba(2, 136, 209, 0.1)', color: 'var(--color-sky-blue)', borderRadius: '50%', width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', fontWeight: 'bold' }}>🩺</span>
                <h3 style={{ fontSize: '1.4rem', color: 'var(--color-slate-black)', margin: 0 }}>Patient-Centered Care</h3>
              </div>
              <p style={{ color: 'var(--color-text-muted-dark)', fontSize: '0.95rem', lineHeight: '1.6', marginBottom: '1rem' }}>
                Our board-certified physicians use state-of-the-art diagnostic ultrasound, X-ray, and EMG to pinpoint the source of your pain. We build custom, comprehensive treatment plans to help you recover and return to activity.
              </p>
              <div style={{ fontSize: '0.85rem', color: 'var(--color-text-muted-dark)' }}>
                <strong>Focus:</strong> Non-surgical orthopedics, spine health, and joint care.<br />
                <strong>Location:</strong> 5387 Manhattan Circle, Boulder, CO 80303.
              </div>
            </div>
          </div>
      ...
      <footer className="premium-footer" style={{ borderTop: '4px solid var(--color-green)' }}>
        ...
        <p className="footer-info">
          Celebrating 25 years of excellence in patient care at Spine West. Specializing in spine, orthopedics, physical medicine, sports injuries, and regenerative medicine to keep you active and on the move.
        </p>
        ...
        <div className="footer-credits">
          ...
          <p style={{ fontSize: '0.75rem', marginTop: '8px', opacity: 0.6 }}>
            Spine West Clinic is located at 5387 Manhattan Circle, Boulder, CO 80303. Phone: (303) 494-7773.
          </p>
        </div>
      </footer>
    </div>
